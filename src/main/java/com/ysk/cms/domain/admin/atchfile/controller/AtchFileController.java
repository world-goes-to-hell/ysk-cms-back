package com.ysk.cms.domain.admin.atchfile.controller;
...
import com.ysk.cms.domain.admin.atchfile.service.AtchFileService;
...
public class AtchFileController {
    ...
    public ApiResponse<PageResponse<AtchFileListDto>> getFilesBySite(
            ...
            @RequestParam(required = false) AtchFileType fileType,
            @PageableDefault(size = 20, sort = "createdAt", direction = Sort.Direction.DESC) Pageable pageable) {
        if (fileType != null) {
