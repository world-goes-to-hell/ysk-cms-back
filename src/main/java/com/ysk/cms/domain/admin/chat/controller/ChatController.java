...
import com.ysk.cms.domain.admin.chat.dto.ChatMessageDto;
import com.ysk.cms.domain.admin.chat.dto.ChatRoomCreateRequest;
import com.ysk.cms.domain.admin.chat.dto.ChatRoomDto;
import com.ysk.cms.domain.admin.chat.dto.ChatRoomUserDto;
...
public class ChatController {
    ...
    public ResponseEntity<ApiResponse<ChatRoomDto>> inviteUsers(
            @PathVariable Long roomId,
            @Valid @RequestBody ChatInviteRequest request,
            @AuthenticationPrincipal UserDetails userDetails
    ) {
        Long userId = chatService.getUserIdByUsername(userDetails.getUsername());
        return ResponseEntity.ok(ApiResponse.success(chatService.inviteUsers(roomId, userId, request)));
    }
